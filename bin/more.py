...
def main(args):
    ...
    parser.add_argument(
        "-p", "--pageno", help="number screen pages cumulatively", action="store_true"
    )
    parser.add_argument(
        "-l", "--lineno", help="number lines cumulatively", action="store_true"
    )
    parser.add_argument(
        "-f", "--filename", help="label lines by filename", action="store_true"
    )
    parser.add_argument(
        "-n", "--filelineno", "-#", help="number lines per file", action="store_true"
    )
    parser.add_argument(
        "-s",
        "--pagesize",
