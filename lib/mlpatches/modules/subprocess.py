...
# constants
try:
    # setup MAXFD. we dont require this, but other scripts may expect this
    # value to be present
...
class Popen(object):
    ...
    def __init__(self, args, bufsize=0, executable=None, stdin=None, stdout=None, stderr=None, preexec_fn=None,
                 close_fds=False, shell=False, cwd=None, env=None, universal_newlines=False, startupinfo=None, creationflags=None):
        # vars
        self._fds = []
