...
def dropbox_setup(username, stdin, stdout):
    ...
    if choice == 2:
        ...
        stdout.write(
            "Please read this. After reading, press enter to continue.\n")
        text1 = "To allow StaSh access to your dropbox, "
        text2 = "you will have to perform the following steps:\n"
        stdout.write(text1 + text2)
        stdout.write(
            "  1) Create a dropbox account (if you dont have one yet)\n")
        stdout.write(
            "  2) Upgrade your Account to a dropbox-developer account.\n")
