...
""",
    ...
    def test_grep_count_single_file_with_name(self):
        ...
        output = self.run_command(
            "grep --count --with-filename 'grep' case_content.txt", exitcode=0
        )
    ...
    def test_grep_count_multiple_files_without_name(self):
        """test 'grep' counting and file name display"""
        output = self.run_command(
            "grep --count --no-filename 'grep' case_content.txt nothing_to_be_found.txt another_file.txt",
            exitcode=0,
        )
        self.assertEqual("2\n0\n1\n", output)
    ...
    def test_grep_text_single_file_with_name(self):
        """test 'grep' text and file name display"""
        output = self.run_command(
            "grep --with-filename 'Grep' case_content.txt", exitcode=0
        )
        self.assertEqual(
            """case_content.txt:test Grep mixed case test
...
""",
    ...
    def test_grep_text_multiple_files(self):
        """test 'grep' text and file name display"""
        output = self.run_command(
            "grep 'Grep' case_content.txt nothing_to_be_found.txt another_file.txt",
            exitcode=0,
        )
        self.assertEqual(
            """case_content.txt:test Grep mixed case test
...
""",
    ...
    def test_grep_text_multiple_files_without_name(self):
        """test 'grep' text and file name display"""
        output = self.run_command(
            "grep --no-filename 'Grep' case_content.txt nothing_to_be_found.txt another_file.txt",
            exitcode=0,
        )
        self.assertEqual(
            """test Grep mixed case test
...
""",
    ...
    def test_grep_stdin(self):
        ...
        output = self.run_command(
            "grep 'Grep'", stdin_text="something\nto Grep\nthrough\n", exitcode=0
        )
    ...
    def test_grep_stdin_and_files(self):
        """test 'grep' to grep through stdin"""
        output = self.run_command(
            "grep 'Grep' case_content.txt - another_file.txt",
            stdin_text="something\nto Grep\nthrough",
            exitcode=0,
        )
        self.assertEqual(
...
""",
    ...
    def test_grep_recursively_without_pattern(self):
        ...
        self.assertEqual(
            sorted(
                """./.hidden:with something to find: grep
...
""".split("\n")
    ...
    def test_grep_recursively_with_pattern(self):
        """test 'grep' to grep recursively through files"""
        output = self.run_command(
            "grep -r 'grep' './*.txt'", exitcode=0
        )  # attention: ./*.txt is single-quoted!!
        self.assertEqual(
            sorted(
                """./case_content.txt:test grep lower case test
./case_content.txt:test grep Grep GREP grep GREP Grep test
...
""".split("\n")
    ...
    def test_grep_line_number_single_file(self):
        ...
        output = self.run_command(
            "grep --line-number 'Grep' case_content.txt", exitcode=0
        )
        self.assertEqual(
            "2:test Grep mixed case test\n4:test grep Grep GREP grep GREP Grep test\n",
            output,
        )
    ...
    def test_grep_line_number_single_file_with_name(self):
        """test 'grep' text with file name display and line number"""
        output = self.run_command(
            "grep --line-number --with-filename 'Grep' case_content.txt", exitcode=0
        )
        self.assertEqual(
            """case_content.txt:2:test Grep mixed case test
...
""",
    ...
    def test_grep_line_number_multiple_files(self):
        """test 'grep' text with file name display and line number"""
        output = self.run_command(
            "grep --line-number 'Grep' case_content.txt nothing_to_be_found.txt another_file.txt",
            exitcode=0,
        )
        self.assertEqual(
            """case_content.txt:2:test Grep mixed case test
...
""",
    ...
    def test_grep_line_number_multiple_files_without_names(self):
        """test 'grep' text with file name display and line number"""
        output = self.run_command(
            "grep --line-number --no-filename 'Grep' case_content.txt nothing_to_be_found.txt another_file.txt",
            exitcode=0,
        )
        self.assertEqual(
            """2:test Grep mixed case test
...
""",
    ...
    def test_grep_just_filenames_without_match_and_count(self):
        """test 'grep' to list file names with and without matches"""
        output = self.run_command(
            "grep --files-without-match --count 'grep' *.txt", exitcode=0
        )
        self.assertEqual(
            [
                "",
    ...
    def test_grep_just_filenames_with_matches(self):
        ...
        self.assertEqual(
            ["", "another_file.txt", "case_content.txt"], sorted(output.split("\n"))
        )

    def test_grep_just_filenames_with_matches_and_count(self):
        """test 'grep' to list file names with and without matches"""
        output = self.run_command(
            "grep --files-with-matches --count 'grep' *.txt", exitcode=0
        )
        self.assertEqual(
            [
                "",
    ...
    def test_grep_only_matching_with_line_number(self):
        """test 'grep' outputing only the matched part of the line"""
        output = self.run_command(
            "grep --line-number --only-matching 'grep\s*\w*' *.txt", exitcode=0
        )
        self.assertEqual(
            [
                "",
    ...
    def test_grep_invert_files_with_matches(self):
        """test 'grep' invert option"""
        output = self.run_command(
            "grep --invert --files-with-matches 'Grep' *.txt", exitcode=0
        )
        self.assertEqual(
            ["", "another_file.txt", "case_content.txt", "nothing_to_be_found.txt"],
            sorted(output.split("\n")),
        )
    ...
    def test_grep_invert_files_without_match(self):
        """test 'grep' invert option"""
        output = self.run_command(
            "grep --invert --files-without-match 'Grep' *.txt", exitcode=0
        )
